    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50/40 flex items-center justify-center px-4 py-20 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {/* Soft gradient blobs */}
                <div className="absolute -top-32 -left-32 w-[450px] h-[450px] bg-[#AE3F4F]/[0.06] rounded-full blur-[100px]" />
                <div className="absolute -bottom-32 -right-32 w-[350px] h-[350px] bg-[#AE3F4F]/[0.04] rounded-full blur-[80px]" />
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-white/80 backdrop-blur-xl bo
                .
                rder border-gray-200/60 rounded-2xl p-8 md:p-10 shadow-xl shadow-gray-200/40">
                    {/* Header */}
                    ...
                    {error && (
                        <div className="mb-6 p-3.5 bg-red-50 border border-red-200/60 rounded-xl flex items-center gap-3">
                            <svg className="w-5 h-5 text-red-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2Z.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2. 5z" />
                            </svg>
